...
export const weddings = [
  {
    ...
    images: [
      ...
      { src: "/client1/4.JPG", alt: "Close up of wedding rings" },
      { src: "/client1/5.JPG", alt: "Bridal henna closeup" },
      { src: "/client1/6.JPG", alt: "Family portrait during the ceremony" },
      { src: "/client1/7.jpg", alt: "Shilpa laughing during the wedding reception" },
      { src: "/client1/8.JPG", alt: "Groom welcoming the bride" },
      { src: "/client1/9.JPG", alt: "Ceremony decoration details" },
      { src: "/client1/10.JPG", alt: "Cake cutting ceremony" },
