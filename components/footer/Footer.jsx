...
export default function FooterMinimal() {
  return (
    <footer className="w-full bg-bg py-16 md:py-24 px-8 border-t border-secondary">
      <div className="max-w-[1600px] mx-auto grid grid-cols-2 md:grid-cols-5 gap-12 font-ui text-sm uppercase tracking-widest text-primary">
        ...
        <div className="col-span-2 md:col-span-2">
          <h3 className="font-display text-xl mb-4 text-primary">Swastik Pictures</h3>
          <p className="text-primary/80 max-w-sm text-[.75em] md:text-sm">Crafting cinematic wedding films with a focus on raw emotion.</p>
        </div>
